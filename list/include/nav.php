         ...
         <div class="container px-lg-5">
             ...
             <div class="collapse navbar-collapse" id="navbarSupportedContent">
                 <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                   ...
                   <li><a class=\"dropdown-item\" href=\"../profil/index.php\">Moj profil</a></li>   
                     <li><a class=\"dropdown-item\" href=\"../zgloszenia/index.php\">Moje zgłoszenia</a></li>
                     <li><a class=\"dropdown-item\" href=\"index.php\">Moje wypożyczenia</a></li>
                   ...
                   <li><a class=\"dropdown-item\" href=\"../zgloszenia/index.php\">Zgłoszenia</a></li>
                     ...
                     <li><a class=\"dropdown-item\" href=\"index.php\">Lista klientów</a></li>                 
                     <li><a class=\"dropdown-item\" href=\"../logout.php\">Wyloguj</a></li> 
                   </ul> </li>";
                    }
                   ...
                   <li><a class=\"dropdown-item\" href=\"../zgloszenia/index.php\">Lista zgłoszeń</a></li>
                     ...
                     <li><a class=\"dropdown-item\" href=\"index.php\">Lista użytkowników</a></li> 
                     <li><a class=\"dropdown-item\" href=\"shop.php\">Lista wypożyczalni</a></li> 
                     <li><a class=\"dropdown-item\" href=\"payments.php\">Lista płatności</a></li> 
                     <li><a class=\"dropdown-item\" href=\"instruments.php\">Lista instrumentów</a></li> 
                     <li><a class=\"dropdown-item\" href=\"../logout.php\">Wyloguj</a></li>
                   </ul> </li>";
                    }
                    ?>
...
if (isset($_GET['info']))
{
    echo "<div class=\"bg-success text-center p-3 h4 \"> <p>".$_GET['info']."</p> </div>";
}
?>