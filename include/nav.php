         ...
         <div class="container px-lg-5">
             ...
             <div class="collapse navbar-collapse" id="navbarSupportedContent">
                 <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                   ...
                   <?php 
                     if(!isset($_GET['status']) && ($_SESSION['rankID']==1))
                     {
                   ...
                   <li><a class=\"dropdown-item\" href=\"zgloszenia/index.php\">Moje zgłoszenia</a></li>
                    ...
                    else if(!isset($_GET['status']) && ($_SESSION['rankID']==2))
                    {
                        echo "<li class=\"nav-item dropdown\"> 
                        <a class=\"nav-link dropdown-toggle\" href=\"#\" id=\"navbarDropdownMenuLink\" role=\"button\" data-bs-toggle=\"dropdown\" aria-expanded=\"false\">
                        ".$_SESSION['login']."
                   ...
                   <li><a class=\"dropdown-item\" href=\"zgloszenia/index.php\">Zgłoszenia</a></li>
                    ...
                    else if(!isset($_GET['status']) && ($_SESSION['rankID']==3))
                    {
                        echo "<li class=\"nav-item dropdown\"> 
                        <a class=\"nav-link dropdown-toggle\" href=\"#\" id=\"navbarDropdownMenuLink\" role=\"button\" data-bs-toggle=\"dropdown\" aria-expanded=\"false\">
                        ".$_SESSION['login']."
...
{
    echo "<div class=\"bg-success text-center p-3 h4 \"> <p class=\"h4\">".$_GET['status']."</p> </div>";
}
if (isset($_GET['logged']))
{
    echo "<div class=\"bg-success text-center p-3 h4 \"> <p class=\"h4\">".$_GET['logged']."</p> </div>";
}
if (isset($_GET['error']))
{
  echo "<div class=\"bg-danger text-center p-3 \"> <p class=\"h4\">".$_GET['error']."</p> </div>";
}
if (isset($_GET['success']))
    {
      echo "<div class=\"bg-success text-center p-3 h4 \"> <p>".$_GET['success']." </p></div>";
    }
?>